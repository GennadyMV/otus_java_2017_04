...
public class ProcessRunnerImpl implements ProcessRunner {
    ...
    public void start(String command, String args) throws IOException {
        process = runProcess(command, args);
    }
    ...
    private Process runProcess(String command, String args) throws IOException {
        ProcessBuilder pb = new ProcessBuilder( "java", "-jar", command, args);
        ...
        System.out.println("started command:" + command + ", process:" + p);
        return p;
    }
