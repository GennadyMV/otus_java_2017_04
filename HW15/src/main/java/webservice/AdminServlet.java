...
public class AdminServlet extends HttpServlet {
    ...
    @Autowired
    private UserCacheMessageSupport userCache;
    ...
    private Map<String, Object> createPageVariablesMap(HttpServletRequest request) {
        ...
        pageVariables.put("hitCount", userCache.getCachInfo().getHitCount());
        pageVariables.put("missCount", userCache.getCachInfo().getMissCount());
